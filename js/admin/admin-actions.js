...
const STUDY_PROVIDERS = {
  ...
  omniroute: { label: 'OmniRoute', host: 'Configured by OMNIROUTE_URL on Render', baseUrl: '', keyField: 'omnirouteApiKeys', modelField: 'omnirouteModel',
              ...
              note: 'Server-side gateway · requires a current OMNIROUTE_URL Render environment variable', keyUrl: '' },
