...
function ezShareWa() {
  const msg = '🎯 PrepStride — SSC/Railway/Banking/UPSC ki smart study planner! Syllabus tracker, mock test analysis, YouTube course organiser — sab ek jagah. Mere link se join karo: ' + ezRefLink();
