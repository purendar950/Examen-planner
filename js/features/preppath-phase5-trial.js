...
function ezExportPdf(title, bodyHtml) {
  ...
  w.document.write(
    '<!DOCTYPE html><html><head><meta charset="utf-8"><title>' + (title || 'PrepStride Export') + '</title>' +
    ...
    '<h1>' + (title || 'PrepStride Export') + '</h1>' +
    '<div class="muted">PrepStride — ' + new Date().toLocaleString('en-IN') + '</div>' +
