...
function applyDashboardV2LayoutFixes() {
  ...
  style.textContent = `
    .dashboard-v2{width:100%;max-width:none;margin:0;padding:12px 20px 30px}
    .dashboard-v2 .dv-topbar{margin-bottom:18px}
    .dashboard-v2 .dv-head{margin-bottom:16px}
    .dashboard-v2 .dv-grid-top{width:100%;grid-template-columns:minmax(270px,.95fr) minmax(420px,1.35fr) minmax(270px,.95fr);gap:12px;align-items:start}
