...
for (const fn of ['createCircle','joinByCode','joinPublic','leaveCircle','setVisibility','renameCircle','togglePin','removeMember','getMyCircles','listPublicCircles','getCircleDetail','setPresence','recordFocusMinutes','getLiveSummary','creationEligibility']) {
...
for (const fn of ['fcSwitchTab','fcOpenCreateModal','fcDoCreate','fcJoinByCode','fcDoJoinPublic','fcOpenDetail','fcRefreshLive']) {
...
for (const id of ['fc-live-text','fc-my-list','fc-discover-list','fc-panel-join','fc-create-overlay','fc-detail-overlay']) {
