...
STUDY_TEST_PROVIDERS = {
    ...
    # ZenMux gateway via its OpenAI-compatible endpoint (Authorization: Bearer key).
    # Model ids use <provider>/<model> form, e.g. x-ai/grok-4.5-free.
    "zenmux":     {"url": "https://zenmux.ai/api/v1/chat/completions", "keyField": "zenmuxApiKeys", "modelField": "zenmuxModel", "def": "x-ai/grok-4.5-free"},
}
...
STUDY_PROVIDER_MODELS = {
    ...
    "zenmux":     ["x-ai/grok-4.5-free", "openai/gpt-5"],
}
...
STUDY_PROVIDER_IDS = ("bynara", "mistral", "cerebras", "openrouter", "nvidia", "google", "hcnsec", "zenmux")
STUDY_PROVIDER_LABELS = {"openrouter": "OpenRouter", "nvidia": "NVIDIA", "google": "Google Gemini", "hcnsec": "HCNSec", "zenmux": "ZenMux"}
